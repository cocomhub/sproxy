...
import (
	...
	"github.com/cocomhub/sproxy/pkg/baidupcs/internal/expires/cachemap"
...
var (
	...
	// dnsResolver 使用标准库解析器；dnsLookupMu 串行化对解析器的调用（裁剪说明：
	// 原实现用 rs/dnscache 做 singleflight 合并，裁剪后去第三方依赖，改用
	// net.DefaultResolver，行为等价且更简单）。

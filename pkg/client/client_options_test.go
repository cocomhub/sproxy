...
func TestWithAccessKey(t *testing.T) {
	...
	if c.accessKey != "test-ak" || c.accessKeySecret != "test-sk" {
		t.Errorf("accessKey/accessKeySecret = %q/%q, want test-ak/test-sk", c.accessKey, c.accessKeySecret)
	}
}
...
func TestWithAccessKey_Empty(t *testing.T) {
	...
	if c.accessKeySecret != "" {
		t.Errorf("accessKeySecret should be empty, got %q", c.accessKeySecret)
	}
}
